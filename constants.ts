  ...
  { 
    ...
    algorithms: [
      { id: 'v0', name: 'Classic', parameters: [
        { id: 'particleCount', name: 'Particles', min: 100, max: 2000, step: 50, defaultValue: 1000 },
        { id: 'particleSpeed', name: 'Particle Speed', min: 0.1, max: 5, step: 0.1, defaultValue: 1.5 },
        { id: 'particleSize', name: 'Particle Size', min: 0.5, max: 5, step: 0.1, defaultValue: 1.5 },
        { id: 'noise', name: 'Noise', min: 0, max: 2, step: 0.1, defaultValue: 0.2 },
        { id: 'trailLength', name: 'Trail Length', min: 1, max: 50, step: 1, defaultValue: 10 },
        { id: 'curlAmount', name: 'Curl Amount', min: 0, max: 10, step: 0.1, defaultValue: 0 },
      ]},
      { id: 'v1', name: 'Vortex', parameters: [
        { id: 'particleCount', name: 'Particles', min: 100, max: 2000, step: 50, defaultValue: 1000 },
        { id: 'vortexStrength', name: 'Vortex Strength', min: 0, max: 10, step: 0.1, defaultValue: 5 },
        { id: 'particleSpeed', name: 'Particle Speed', min: 0.1, max: 5, step: 0.1, defaultValue: 1.0 },
        { id: 'particleSize', name: 'Particle Size', min: 0.5, max: 5, step: 0.1, defaultValue: 1.5 },
        { id: 'trailLength', name: 'Trail Length', min: 1, max: 50, step: 1, defaultValue: 15 },
        { id: 'curlAmount', name: 'Curl Amount', min: 0, max: 10, step: 0.1, defaultValue: 2 },
      ]},
      { id: 'v2', name: 'Gravity Wells', parameters: [
        { id: 'particleCount', name: 'Particles', min: 100, max: 2000, step: 50, defaultValue: 1000 },
        { id: 'wellPower', name: 'Well Power', min: 10, max: 200, step: 5, defaultValue: 75 },
        { id: 'gravityStrength', name: 'Gravity Strength', min: 0, max: 100, step: 1, defaultValue: 50 },
        { id: 'particleSpeed', name: 'Particle Speed', min: 0.1, max: 5, step: 0.1, defaultValue: 1.0 },
        { id: 'particleSize', name: 'Particle Size', min: 0.5, max: 5, step: 0.1, defaultValue: 1.5 },
        { id: 'trailLength', name: 'Trail Length', min: 1, max: 30, step: 1, defaultValue: 5 },
        { id: 'curlAmount', name: 'Curl Amount', min: 0, max: 10, step: 0.1, defaultValue: 0 },
      ]},
